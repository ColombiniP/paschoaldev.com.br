	...
	wp.customize( control, function( value ) {
		value.bind( function( new_value ) {
			...
			if ( new_value || 0 === new_value ) {
				...
				/**
				 *	If ( unit == 'url' ) then = url('/wp-content/themes/astra/assets/js/unminified/{VALUE}')
				...
				if ( 'undefined' != typeof unit) {
					...
					if ( 'url' === unit ) {
						new_value = 'url('/wp-content/themes/astra/assets/js/unminified/+ new_value +')';
					} else {
			...
			if ( new_value ) {
				...
				if ( fontName in astraCustomizer.googleFonts ) {
					...
					if( new_value === "inherit" ) {
						link = '<link id="' + font_control + '" href="https://fonts.googleapis.com/css?family='%20+%20fontName%20+%20'" rel="stylesheet">';
					} else {
						link = '<link id="' + font_control + '" href="https://fonts.googleapis.com/css?family='%20+%20fontName%20+%20'%3A'%20+%20new_value%20+%20'" rel="stylesheet">';
					}
				}
	...
	wp.customize( 'astra-settings[header-main-menu-label]', function( setting ) {
		setting.bind( function( label ) {
			if( $('button.main-header-menu-toggle .mobile-menu-wrap .mobile-menu').length > 0 ) {
				...
				if( '' != label ) {
					html += '<div class="mobile-menu-wrap"><span class="mobile-menu">'+ label +' ';
				}
